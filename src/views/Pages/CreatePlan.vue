...
type Toast = { id: number; title: string; description?: string; variant?: "success" | "destructive" };
...
async function handleSave() {
    if (!formData.title || !formData.subject || !formData.grade) {
        toast({
            ...
            description: "Por favor, preencha pelo menos o título, disciplina e série.",
            variant: "destructive",
        });
        return;
    }
    ...
    try {
        await storage.save(id, newPlan);

        toast({
            title: "Plano salvo com sucesso!",
            description: "O plano foi armazenado no banco local.",
            variant: "success",
        });
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="card shadow">
                        <div class="card-body space-y-4">
                            ...
                            <div>
                                <label class="label" for="title"><span class="label-text">Título do Plano
                                        *</span></label>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label class="label" required for="subject"><span class="label-text">Disciplina
                                            *</span></label>
                                ...
                                <div>
                                    <label class="label" required for="grade"><span class="label-text">Série/Ano
                                            *</span></label>
                                    <select id="grade" class="select select-bordered w-full shadow"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select id="duration" class="select select-bordered w-full shadow"
                                ...
                                <div>
                                    ...
                                    <input id="date" type="date" class="input input-bordered w-full shadow"
                            ...
                            <div class="space-y-2">
                                <div v-for="(objective, index) in formData.objectives" :key="index" class="flex gap-2">
                                    ...
                                    <button v-if="formData.objectives.length > 1" type="button"
                                        class="btn btn-outline btn-sm px-3" @click="removeObjective(index)"
